...
Responder is a very easy machine on Hack The Box Starting Point Tier 1 that focuses on remote file inclusion vulnerabilities. It also focuses on using the Responder, John the Ripper, the Evil-WinRM tools.
